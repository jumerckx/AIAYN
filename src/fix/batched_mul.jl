# see also https://github.com/chengchingwen/Transformers.jl/tree/master/src/fix for the original code this fix is based on.

import Flux: Zygote.@adjoint, NNlib.batched_gemm!
import CUDA: CuArray
